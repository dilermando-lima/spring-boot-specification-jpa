...
import demo.filter.FilterRequest;
...
import demo.service.EmployeeService.ListRequestDTO;
...
public class EmployeeController {
    ...
    @RequiresProfile(UserProfile.READER)
    @GetMapping
    public List<ListItemResponseDTO> list(@FilterRequest ListRequestDTO listRequest){
        return companyService.list(listRequest);
    }
